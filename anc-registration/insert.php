...
mysql_select_db ($database, $connection);
		$query_first = "SELECT register_anc_1st.motherid FROM bidan_prepopulated.register_anc_1st WHERE motherid IN (SELECT motherid FROM bidan_prepopulated.register_anc_2nd) and motherid not in (SELECT motherid FROM bidan_prepopulated.register_anc_3rd)";
