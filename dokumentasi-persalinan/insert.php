...
mysql_select_db ($database, $connection);
		$query_first = "SELECT dokumentasi_persalinan_1st.motherid FROM bidan_prepopulated.dokumentasi_persalinan_1st WHERE motherid IN (SELECT motherid FROM bidan_prepopulated.dokumentasi_persalinan_2nd) and motherid not in (SELECT motherid FROM bidan_prepopulated.dokumentasi_persalinan_3rd)";
