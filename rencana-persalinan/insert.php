...
mysql_select_db ($database, $connection);
		$query_first = "SELECT rencana_persalinan_1st.motherid FROM bidan_prepopulated.rencana_persalinan_1st WHERE motherid IN (SELECT motherid FROM bidan_prepopulated.rencana_persalinan_2nd) and motherid not in (SELECT motherid FROM bidan_prepopulated.rencana_persalinan_3rd)";
